...
| INF-02 | Docker Compose: Vaultwarden + PostgreSQL | P0 | done |
| INF-03 | Configurar variáveis de ambiente (`.env`) — sem segredos versionados | P0 | done |
...
| POC-07 | Definir e testar política de grupos e compartilhamento | P1 | done |
